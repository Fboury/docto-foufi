...
var DataRouterContext = X(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = X(null);
DataRouterStateContext.displayName = "DataRouterState";
var RSCRouterContext = X(false);
function useIsRSCRouterContext() {
  return x(RSCRouterContext);
}
var ViewTransitionContext = X({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = X(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = X(null);
AwaitContext.displayName = "Await";
var AwaitContextProvider = (props) => k(AwaitContext.Provider, props);
var NavigationContext = X(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = X(
  null
);
...
function useHref(to, { relative } = {}) {
  ...
  let { basename, navigator } = x(NavigationContext);
...
function useLocation() {
  ...
  return x(LocationContext).location;
}
function useNavigationType() {
  return x(LocationContext).navigationType;
}
...
function useIsomorphicLayoutEffect(cb) {
  let isStatic = x(NavigationContext).static;
  if (!isStatic) {
    _(cb);
  }
}
function useNavigate() {
  let { isDataRoute } = x(RouteContext);
...
function useNavigateUnstable() {
  ...
  let dataRouterContext = x(DataRouterContext);
  let { basename, navigator } = x(NavigationContext);
  let { matches } = x(RouteContext);
  let { pathname: locationPathname } = useLocation();
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
  let activeRef = A(false);
...
var OutletContext = X(null);
function useOutletContext() {
  return x(OutletContext);
}
function useOutlet(context) {
  let outlet = x(RouteContext).outlet;
  return T(
    () => outlet && k(OutletContext.Provider, { value: context }, outlet),
    [outlet, context]
  );
}
function useParams() {
...
function useRoutesImpl(routes, locationArg, dataRouterState, onError, future) {
  ...
  let { navigator } = x(NavigationContext);
  let { matches: parentMatches } = x(RouteContext);
...
function DefaultErrorComponent() {
  ...
  if (ENABLE_DEV_WARNINGS) {
    ...
    devInfo = k(S, null, k("p", null, "💿 Hey developer 👋"), k("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", k("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", k("code", { style: codeStyles }, "errorElement"), " prop on your route."));
  }
  return k(S, null, k("h2", null, "Unexpected Application Error!"), k("h3", { style: { fontStyle: "italic" } }, message), stack ? k("pre", { style: preStyles }, stack) : null, devInfo);
}
var defaultErrorElement = k(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends C {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let result = error !== void 0 ? k(RouteContext.Provider, { value: this.props.routeContext }, k(
    ...
    if (this.context) {
      return k(RSCErrorHandler, { error }, result);
    }
    return result;
  }
};
...
function RSCErrorHandler({
  ...
  let { basename } = x(NavigationContext);
...
function RenderedRoute({ routeContext, match, children }) {
  ...
  return k(RouteContext.Provider, { value: routeContext }, children);
}
    ...
    (outlet, match, index) => {
      ...
      let getChildren = () => {
        ...
        if (error) {
          ...
          children = k(match.route.Component, null);
      ...
      return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? k(
        RenderErrorBoundary,
        {
          location: dataRouterState.location,
...
function useDataRouterContext(hookName) {
  let ctx = x(DataRouterContext);
  invariant(ctx, getDataRouterConsoleError(hookName));
  return ctx;
}
function useDataRouterState(hookName) {
  let state = x(DataRouterStateContext);
  invariant(state, getDataRouterConsoleError(hookName));
  return state;
}
function useRouteContext(hookName) {
  let route = x(RouteContext);
...
function useBlocker(shouldBlock) {
  ...
  let [blockerKey, setBlockerKey] = d("");
  let blockerFunction = q(
    (arg) => {
...
var useOptimisticImpl = compat_module_exports[USE_OPTIMISTIC];
...
function mapRouteProperties(route) {
  ...
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: k(route.HydrateFallback),
  ...
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: k(route.ErrorBoundary),
...
function RouterProvider({
  ...
  let [_state, setStateImpl] = d(router.state);
  let [state, setOptimisticState] = useOptimisticSafe(_state);
  let [pendingState, setPendingState] = d();
  let [vtContext, setVtContext] = d({
    isTransitioning: false
  });
  let [renderDfd, setRenderDfd] = d();
  let [transition, setTransition] = d();
  let [interruption, setInterruption] = d();
  let fetcherData = A(/* @__PURE__ */ new Map());
  let setState = q(
  ...
  _(() => router.subscribe(setState), [router, setState]);
  h(() => {
  ...
  return k(S, null, k(DataRouterContext.Provider, { value: dataRouterContext }, k(DataRouterStateContext.Provider, { value: state }, k(FetchersContext.Provider, { value: fetcherData.current }, k(ViewTransitionContext.Provider, { value: vtContext }, k(
    Router,
    {
      basename,
      location: state.location,
...
var MemoizedDataRoutes = N(DataRoutes);
function DataRoutes({
  routes,
  future,
  state,
...
function Navigate({
  ...
  let { static: isStatic } = x(NavigationContext);
  warning(
    !isStatic,
...
function Router({
  ...
  return k(NavigationContext.Provider, { value: navigationContext }, k(LocationContext.Provider, { children, value: locationContext }));
}
function Routes({
  children,
  location
...
function Await({
  ...
  let dataRouterContext = x(DataRouterContext);
  let dataRouterStateContext = x(DataRouterStateContext);
  let onError = q(
    (error, errorInfo) => {
  ...
  return k(
    ...
    k(ResolveAwait, null, children)
  );
}
var AwaitErrorBoundary = class extends C {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (status === 2) {
      return k(AwaitContext.Provider, { value: promise, children: errorElement });
    }
    if (status === 1) {
      return k(AwaitContext.Provider, { value: promise, children });
    }
    throw promise;
  }
};
function ResolveAwait({
  ...
  return k(S, null, toRender);
}
function createRoutesFromChildren(children, parentPath = []) {
  let routes = [];
  L.forEach(children, (element, index) => {
    if (!hn(element)) {
      return;
    }
...
function WithComponentProps({
  ...
  return mn(children, props);
}
function withComponentProps(Component4) {
  return function WithComponentProps2() {
    const props = useRouteComponentProps();
    return k(Component4, props);
  };
}
...
function withHydrateFallbackProps(HydrateFallback) {
  return function WithHydrateFallbackProps2() {
    const props = useHydrateFallbackProps();
    return k(HydrateFallback, props);
  };
}
      ...
      case "object": {
        ...
        if (!pluginHandled) {
          ...
          if (isArray) {
            ...
            if (input2.size > 0) {
              str[index2] = `["${TYPE_MAP}",${[...input2].flatMap(([k2, v]) => [
        ...
        switch (type) {
          ...
          case TYPE_PROMISE:
            if (hydrated[b]) {
              ...
              const d2 = new Deferred2();
              deferred[b] = d2;
              set(hydrated[index2] = d2.promise);
            }
            continue;
          case TYPE_ERROR:
...
function StreamTransfer({
  ...
  if (done) {
    ...
    return k(S, null, scriptTag, k(P, null, k(
      StreamTransfer,
      {
        context,
...
async function singleFetchLoaderNavigationStrategy(args, router, getRouteInfo, fetchAndDecode, ssr, basename, shouldAllowOptOut = () => true) {
  ...
  await Promise.all(routeDfds.map((d2) => d2.promise));
...
function RemixRootDefaultHydrateFallback() {
  return k(BoundaryShell, { title: "Loading...", renderScripts: true }, ENABLE_DEV_WARNINGS ? k(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => k(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component4 ? {
        element: k(routeModule.Layout, null, k(Component4, null))
      } : { Component: Component4 },
      ...ErrorBoundary ? {
        errorElement: k(routeModule.Layout, null, k(ErrorBoundary, null))
      } : { ErrorBoundary },
      ...HydrateFallback ? {
        hydrateFallbackElement: k(routeModule.Layout, null, k(HydrateFallback, null))
      } : { HydrateFallback }
    };
  }
  ...
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    if (routeModule) {
      ...
      if (!route.hasClientLoader) {
        dataRoute.loader = (_2, singleFetch) => prefetchStylesAndCallHandler(() => {
          return fetchServerLoader(singleFetch);
        });
      }
      if (!route.hasClientAction) {
        dataRoute.action = (_2, singleFetch) => prefetchStylesAndCallHandler(() => {
          if (isSpaMode) {
            throw noActionDefinedError("clientAction", route.id);
          }
          return fetchServerAction(singleFetch);
...
function useDataRouterContext2() {
  let context = x(DataRouterContext);
  invariant2(
    context,
...
function useDataRouterStateContext() {
  let context = x(DataRouterStateContext);
  invariant2(
    context,
...
var FrameworkContext = X(void 0);
FrameworkContext.displayName = "FrameworkContext";
function useFrameworkContext() {
  let context = x(FrameworkContext);
  invariant2(
    context,
...
function usePrefetchBehavior(prefetch, theirElementProps) {
  let frameworkContext = x(FrameworkContext);
...
function Links({ nonce }) {
  ...
  return k(S, null, typeof criticalCss === "string" ? k(
    "style",
    {
      ...{ [CRITICAL_CSS_DATA_ATTRIBUTE]: "" },
      dangerouslySetInnerHTML: { __html: criticalCss }
    }
  ) : null, typeof criticalCss === "object" ? k(
    "link",
    {
      ...{ [CRITICAL_CSS_DATA_ATTRIBUTE]: "" },
      rel: "stylesheet",
    ...
    ({ key, link }) => isPageLinkDescriptor(link) ? k(PrefetchPageLinks, { key, nonce, ...link }) : k("link", { key, nonce, ...link })
  ));
}
function PrefetchPageLinks({ page, ...linkProps }) {
  ...
  return k(PrefetchPageLinksImpl, { page, matches, ...linkProps });
}
...
function PrefetchPageLinksImpl({
  ...
  return k(S, null, dataHrefs.map((href2) => k("link", { key: href2, rel: "prefetch", as: "fetch", href: href2, ...linkProps })), moduleHrefs.map((href2) => k("link", { key: href2, rel: "modulepreload", href: href2, ...linkProps })), keyedPrefetchLinks.map(({ key, link }) => (
    // these don't spread `linkProps` because they are full link descriptors
    // already with their own props
    k("link", { key, nonce: linkProps.nonce, ...link })
  )));
}
function Meta() {
  ...
  return k(S, null, meta.flat().map((metaProps) => {
    if (!metaProps) {
      return null;
    }
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return k(Comp, { key: JSON.stringify(rest), ...rest });
    }
    if ("title" in metaProps) {
      return k("title", { key: "title" }, String(metaProps.title));
    }
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? k("meta", { key: "charSet", charSet: metaProps.charSet }) : null;
    }
    ...
    return k("meta", { key: JSON.stringify(metaProps), ...metaProps });
  }));
}
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  return isHydrated || isRSCRouterContext ? null : k(S, null, typeof manifest.sri === "object" ? k(
    "script",
    {
      "rr-importmap": "",
      type: "importmap",
...
var RemixErrorBoundary = class extends C {
  constructor(props) {
    super(props);
...
function RemixRootDefaultErrorBoundary({
  ...
  if (isRouteErrorResponse(error)) {
    return k(BoundaryShell, { title: "Unhandled Thrown Response!" }, k("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), ENABLE_DEV_WARNINGS ? heyDeveloper : null);
  }
  let errorInstance;
  ...
  return k(
    ...
    k("h1", { style: { fontSize: "24px" } }, "Application Error"),
    k(
      "pre",
      {
        style: {
...
function BoundaryShell({
  ...
  return k("html", { lang: "en" }, k("head", null, k("meta", { charSet: "utf-8" }), k(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), k("title", null, title)), k("body", null, k("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children, renderScripts ? k(Scripts, null) : null)));
}
...
var Link = D(
  function LinkWithRef({
    ...
    let { basename, unstable_useTransitions } = x(NavigationContext);
    ...
    return shouldPrefetch && !isAbsolute ? k(S, null, link, k(PrefetchPageLinks, { page: href2 })) : link;
  }
);
...
var NavLink = D(
  function NavLinkWithRef({
    ...
    let location = useLocation();
    let routerState = x(DataRouterStateContext);
    let { navigator, basename } = x(NavigationContext);
...
var Form = D(
  ({
    ...
    let { unstable_useTransitions } = x(NavigationContext);
...
function ScrollRestoration({
  ...
  let remixContext = x(FrameworkContext);
  let { basename } = x(NavigationContext);
  let location = useLocation();
...
function useSearchParams(defaultInit) {
  ...
  let defaultSearchParamsRef = A(createSearchParams(defaultInit));
  let hasSetSearchParamsRef = A(false);
  let location = useLocation();
  let searchParams = T(
    () => (
...
function useFormAction(action, { relative } = {}) {
  let { basename } = x(NavigationContext);
  let routeContext = x(RouteContext);
...
function useFetcher({
  ...
  let fetcherData = x(FetchersContext);
  let route = x(RouteContext);
  ...
  let defaultKey = g();
  let [fetcherKey, setFetcherKey] = d(key || defaultKey);
  ...
  let FetcherForm = T(() => {
    let FetcherForm2 = D(
      (props, ref) => {
        return k(Form, { ...props, navigate: false, fetcherKey, ref });
      }
    );
...
function useViewTransitionState(to, { relative } = {}) {
  let vtContext = x(ViewTransitionContext);
  invariant(
    vtContext != null,
...
function StaticRouterProvider({
  ...
  return k(S, null, k(DataRouterContext.Provider, { value: dataRouterContext }, k(DataRouterStateContext.Provider, { value: state }, k(FetchersContext.Provider, { value: fetchersContext }, k(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, k(
    Router,
    {
...
function ServerRouter({
  ...
  return k(S, null, k(
    ...
    k(RemixErrorBoundary, { location: router.state.location }, k(
  ...
  ), context.serverHandoffStream ? k(P, null, k(
    StreamTransfer,
    {
      context,
      identifier: 0,
...
function createRoutesStub(routes, _context) {
  return function RoutesTestStub({
    ...
    return k(FrameworkContext.Provider, { value: frameworkContextRef.current }, k(RouterProvider, { router: routerRef.current }));
  };
}
...
var RSCRouterGlobalErrorBoundary = class extends gn.Component {
  constructor(props) {
    super(props);
...
function ErrorWrapper({
  ...
  return gn.createElement("html", { lang: "en" }, gn.createElement("head", null, gn.createElement("meta", { charSet: "utf-8" }), gn.createElement(
    "meta",
    {
      name: "viewport",
      content: "width=device-width,initial-scale=1,viewport-fit=cover"
    }
  ), gn.createElement("title", null, title)), gn.createElement("body", null, gn.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({
  ...
  console.error(error);
  let heyDeveloper = gn.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
  ...
  if (isRouteErrorResponse(error)) {
    return gn.createElement(
      ...
      gn.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText),
  ...
  return gn.createElement(ErrorWrapper, { renderAppShell, title: "Application Error!" }, gn.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), gn.createElement(
    "pre",
    {
      style: {
        padding: "2rem",
...
var REACT_USE = "use";
var useImpl = compat_module_exports[REACT_USE];
...
function RSCStaticRouter({ getPayload }) {
  ...
  return k(RSCRouterContext.Provider, { value: true }, k(RSCRouterGlobalErrorBoundary, { location: payload.location }, k(FrameworkContext.Provider, { value: frameworkContext }, k(
    StaticRouterProvider,
    {
      context,
      router,
