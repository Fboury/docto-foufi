...
export const Dashboard: React.FC = () => {
  ...
  const { recommendedZone, injections } = useInjections();

  const recommendedZoneData = ZONES_CONFIG.find(z => z.id === recommendedZone);
  ...
  return (
    <div className="mx-auto max-w-xl space-y-6 px-4 py-6">
      ...
      {/* CARTE D'ACTION PRINCIPALE : Bouton vers la page AddInjection */}
      <div
